...
export default function Find() {
    return (
        <div className="w-full h-96">
            ...
            <div className="relative w-screen items-center justify-center mx-auto text-center  img__heading pt-20">
            <Image src="/images/malish.png" alt="malish" className="absolute w-4/3 " width={1000} height={300} />
